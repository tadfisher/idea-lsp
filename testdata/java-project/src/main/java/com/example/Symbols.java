...
@Deprecated
public class Symbols<T extends List<int[]>, X> extends Base implements Serializable {
    ...
    public <T> Symbols(String str) {
    }

    private class QWE extends Symbols<List<int[]>, String> {
    ...
    public static void main(String[] args) throws IOException {
        int x = 2;
        Symbols teste = new Symbols(2);
        Symbols.QWE qwe = teste.new QWE(1);
        if (1 + 1 == 2) {
            teste = null;
            teste = new Symbols(1);
        } else {
